...
public class PdfWatermark extends PdfWorker {
  ...
  public PdfWatermark() {
    super(WORKERTYPE_PDF_WATERMARK, Arrays.asList(
            ...
            RunnerParameter.getInstance(INPUT_WATERMARK, "Watermark", String.class, RunnerParameter.Level.REQUIRED,
                "Watermark to add"),
            RunnerParameter.getInstance(INPUT_WATERMARK_POSITION, "Watermark position", String.class,
                    PdfToolbox.TEXT_POSITION.CENTER.toString(), RunnerParameter.Level.OPTIONAL,
                    "Text position (" + PdfToolbox.TEXT_POSITION.TOP + ", " + PdfToolbox.TEXT_POSITION.CENTER + ","
                        + PdfToolbox.TEXT_POSITION.BOTTOM + ")")
            ...
            RunnerParameter.getInstance(INPUT_WATERMARK_COLOR, "Color", String.class, RunnerParameter.Level.OPTIONAL,
            ...
            RunnerParameter.getInstance(INPUT_WATERMARK_ROTATION, "Rotation (degree)", Integer.class,
            ...
            RunnerParameter.getInstance(INPUT_DESTINATION_STORAGEDEFINITION, "Storage definition", String.class,
            ...
            RunnerParameter.getInstance(OUTPUT_DESTINATION_FILE, "Output destination file", Object.class,
  ...
  public String getDescription() {
    return
        "Place a watermark in a PDF file. Different positions are possible: TOP, CENTER, BOTTOM. On the CENTER position, a rotation can be provided.\n"
  ...
  public void execute(final JobClient jobClient, final ActivatedJob activatedJob, ContextExecution contextExecution) {
    ...
    try {
      ...
      if (sourceFileVariable == null || sourceFileVariable.getValue() == null) {
        throw new ZeebeBpmnError(BPMERROR_LOAD_FILE_ERROR,
            "Worker [" + getName() + "] cannot read file[" + INPUT_SOURCE_FILE + "]");
      }
      ...
      PdfToolbox.TEXT_POSITION textPosition = PdfToolbox.TEXT_POSITION.valueOf(
          getInputStringValue(INPUT_WATERMARK_POSITION, PdfToolbox.TEXT_POSITION.CENTER.toString(), activatedJob));
      ...
      if (watermarkColorSt != null) {
        ...
        if (color == null)
          throw new ZeebeBpmnError(BPMERROR_INVALID_COLOR,
              "Worker [" + getName() + "] Color [" + watermarkColorSt + "] is unknow]");
      ...
      saveOutputPdfDocument(sourceDocument, destinationFileName, OUTPUT_DESTINATION_FILE, destinationStorageDefinition,
          contextExecution);

    } catch (Exception e) {
      logError("During extraction " + e);
      throw new ZeebeBpmnError(BPMERROR_OPERATION_ERROR,
          "Worker [" + getName() + "] cannot execute watermark operation on ["
    ...
    logInfo("Cherry.PdfWatermark: from document[" + sourceFileVariable.getName() + "] to [" + destinationFileName + "]");
  }
