...
public class PdfWatermark extends PdfWorker {
    ...
    public PdfWatermark() {
        super(WORKERTYPE_PDF_WATERMARK,
                Arrays.asList(
                        ...
                        AbstractWorker.WorkerParameter.getInstance(INPUT_WATERMARK, "Watermark", String.class, Level.REQUIRED, "Watermark to add"),
                        AbstractWorker.WorkerParameter.getInstance(INPUT_WATERMARK_POSITION, "Watermark position",
                                        String.class,
                        ...
                        AbstractWorker.WorkerParameter.getInstance(INPUT_WATERMARK_COLOR, "Color", String.class, Level.OPTIONAL, "Color to display the watermark")
                                .addChoice("RED", "red")
                        ...
                        AbstractWorker.WorkerParameter.getInstance(INPUT_WATERMARK_ROTATION, "Rotation (degree)", Integer.class, Level.OPTIONAL, "Rotation (0-360)"),
                        ...
                        AbstractWorker.WorkerParameter.getInstance(INPUT_DESTINATION_STORAGEDEFINITION, "Storage definition", String.class, FileVariableFactory.FileVariableStorage.JSON.toString(), Level.OPTIONAL, "Storage Definition use to describe how to save the file")


                ),
                Collections.singletonList(
                        AbstractWorker.WorkerParameter.getInstance(OUTPUT_DESTINATION_FILE, "Output destination file", Object.class, Level.REQUIRED, "FileVariable converted")
                ),
                Arrays.asList(AbstractWorker.BpmnError.getInstance(BPMERROR_ENCRYPTED_NOT_SUPPORTED, "PDF Encripted file not supported"),
                        ...
                        AbstractWorker.BpmnError.getInstance(BPMERROR_INVALID_COLOR, "Invalid color"),
                        AbstractWorker.BpmnError.getInstance(BPMERROR_OPERATION_ERROR, "Operation error")));
    }

    /**
     * Get the logo for this worker
     *
     * @return the logo (SVG)
     */
    ...
    @Override
    @ZeebeWorker(type = WORKERTYPE_PDF_WATERMARK, autoComplete = true)
