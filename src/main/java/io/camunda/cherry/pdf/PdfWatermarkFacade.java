...
@Component
public class PdfWatermarkFacade extends AbstractConnector {
  ...
  public PdfWatermarkFacade() {
    super(PdfWatermarkFunction.TYPE_PDF_WATERMARK, Arrays.asList(
        RunnerParameter.getInstance(PdfWatermarkInput.INPUT_SOURCE_FILE, "Source file", Object.class,
            RunnerParameter.Level.REQUIRED, "FileVariable for the file to convert"),
        RunnerParameter.getInstance(PdfWatermarkInput.INPUT_WATERMARK, "Watermark", String.class,
            RunnerParameter.Level.REQUIRED, "Watermark to add"),
        RunnerParameter.getInstance(PdfWatermarkInput.INPUT_WATERMARK_POSITION, "Watermark position", String.class,
        ...
        RunnerParameter.getInstance(PdfWatermarkInput.INPUT_DESTINATION_FILE_NAME, "Destination file name",
            String.class, RunnerParameter.Level.REQUIRED, "Destination file name"),
        RunnerParameter.getInstance(PdfWatermarkInput.INPUT_DESTINATION_STORAGEDEFINITION, "Storage definition",
            String.class, StorageDefinition.StorageDefinitionType.JSON.toString(), RunnerParameter.Level.OPTIONAL,
  ...
  public String getName() {
    ...
    return pdfWatermarkFunction.getName();
