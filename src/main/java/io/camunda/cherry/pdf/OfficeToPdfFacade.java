...
@Component
public class OfficeToPdfFacade extends AbstractConnector {
  ...
  public OfficeToPdfFacade() {
    super(OfficeToPdfFunction.WORKERTYPE_PDF_CONVERT_TO,
        // List of Input parameters
        Arrays.asList(
            RunnerParameter.getInstance(OfficeToPdfInput.INPUT_SOURCE_FILE_VARIABLE, "Source file", Object.class,
        ...
        // List of BPMNErrors
        Arrays.asList(BpmnError.getInstance(OfficeToPdfFunction.BPMERROR_CONVERSION_ERROR, "Conversion error"),
            BpmnError.getInstance(OfficeToPdfFunction.BPMERROR_LOAD_FILE_ERROR, "Load File error")));
  }
